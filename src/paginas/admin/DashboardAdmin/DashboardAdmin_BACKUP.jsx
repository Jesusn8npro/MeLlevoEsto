    ...
    <div className="admin-test-content">
        ...
        <div className="admin-test-card">
          ...
          <div className="user-info">
            ...
            <div className="user-details">
              ...
              <p><strong>Rol:</strong> {usuario?.rol || 'admin'}</p>
              <p><strong>ID:</strong> {usuario?.id?.slice(0, 8) || 'No disponible'}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="success-banner">
        ...
        <div className="banner-content">
          <h3>¡Dashboard Admin Completo!</h3>
          <p>
            Sistema de administración completamente funcional con autenticación real, 
            gestión de E-commerce y datos en tiempo real desde Supabase.
          </p>
        </div>
      </div>
    </div>
